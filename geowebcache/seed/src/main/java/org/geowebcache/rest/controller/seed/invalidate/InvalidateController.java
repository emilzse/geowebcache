...
public class InvalidateController {
    ...
    @Autowired private InvalidateService invalidateService;
     ...
     * @param layer
     * @param zxy z/x/y
     * @param jobId unique id to be used to keep track of deleted tiles for this job. Use same id
     *     for validate
     * @return
     */
    ...
    public ResponseEntity<?> doGet(
            ...
            @RequestParam("zxy") String zxy,
            @RequestParam("jobId") String jobId,
            @RequestParam(value = "poolSize", defaultValue = "1") int poolSize) {
    ...
    public ResponseEntity<?> doPost(
        ...
        String formatExtension =
                jobId.indexOf(".") == -1 ? "xml" : jobId.substring(jobId.indexOf(".") + 1);
