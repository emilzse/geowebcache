...
//    }
    ...
    protected TileLayer deserializeAndCheckLayerInternal(String layerName, String formatExtension,
        ...
        XStream xs = configDispatcher.getConfiguredXStreamWithContext(new GeoWebCacheXStream(new DomDriver()), Context.REST);
    ...
    public ResponseEntity<?> listLayers(String extension, final String rootPath, final String contextPath) {
        ...
        if (extension.equalsIgnoreCase("xml")) {
            ...
            configDispatcher.getConfiguredXStreamWithContext(xStream, Context.REST);
    ...
    public ResponseEntity<?> getXMLRepresentation(TileLayer layer) {
        XStream xs = configDispatcher.getConfiguredXStreamWithContext(new GeoWebCacheXStream(), Context.REST);
    ...
    public ResponseEntity<?> getJsonRepresentation(TileLayer layer) {
        JSONObject rep = null;
        try {
            XStream xs = configDispatcher.getConfiguredXStreamWithContext(new GeoWebCacheXStream(
