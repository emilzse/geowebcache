...
public abstract class AbstractBlobStoreTest<TestClass extends BlobStore> {
    ...
    public void testEmpty() throws Exception {
        TileObject fromCache = TileObject.createQueryTileObject("testLayer",
                new long[] { 0L, 0L, 0L }, "testGridSet", "image/png");
    ...
    public void testStoreTilesInMultipleLayers() throws Exception {
        ...
        TileObject fromCache1 = TileObject.createQueryTileObject("testLayer1",
                new long[] { 0L, 0L, 0L }, "testGridSet", "image/png");
        TileObject fromCache2_1 = TileObject.createQueryTileObject("testLayer2",
                new long[] { 0L, 0L, 0L }, "testGridSet", "image/png");
        TileObject fromCache2_2 = TileObject.createQueryTileObject("testLayer2",
                new long[] { 0L, 0L, 0L }, "testGridSet", "image/png");
        
        if(events) {
            listener.tileStored(eq("testLayer1"), eq("testGridSet"), eq("image/png"), eq(null),
                    eq(0L), eq(0L), eq(0), geq(size1), eq(0), eq(null), eq(null));
            listener.tileStored(eq("testLayer2"), eq("testGridSet"), eq("image/png"), eq(null),
                    eq(0L), eq(0L), eq(0), geq(size2), eq(0), eq(null), eq(null));
        }
    ...
    public void testDeleteTile() throws Exception {
        ...
        store.addListener(listener);
        TileObject toCache = TileObject.createCompleteTileObject("testLayer",  new long[]{0L, 0L, 0L}, "testGridSet", "image/png", null, new ByteArrayResource("1,2,4,5,6 test".getBytes(StandardCharsets.UTF_8)));
        TileObject remove = TileObject.createQueryTileObject("testLayer", new long[] { 0L, 0L, 0L },
                "testGridSet", "image/png");
        TileObject fromCache = TileObject.createQueryTileObject("testLayer",
                new long[] { 0L, 0L, 0L }, "testGridSet", "image/png");
        
        Capture<Long> sizeCapture = new Capture<>();
        if(events) {
            listener.tileStored(eq("testLayer"), eq("testGridSet"), eq("image/png"), eq(null),
                    eq(0L), eq(0L), eq(0), capture(sizeCapture), eq(0), eq(null), eq(null)
                );EasyMock.expectLastCall();
        }
    ...
    public void testUpdateTile() throws Exception {
        ...
        final long size2 = toCache2.getBlobSize();
        TileObject fromCache = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet", "image/png");
        
        Capture<Long> sizeCapture = new Capture<>();
        if(events){
            listener.tileStored(eq("testLayer"), eq("testGridSet"), eq("image/png"), eq(null), eq(0L), eq(0L), eq(0), 
                capture(sizeCapture), eq(0), eq(null), eq(null)
                );EasyMock.expectLastCall();
        }
        EasyMock.replay(listener);
    ...
    public void testGridsets() throws Exception {
        ...
        final long size1 = toCache1.getBlobSize();
        final long size2 = toCache2.getBlobSize();
        TileObject remove = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet1", "image/png");
        TileObject fromCache1_1 = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet1", "image/png");
        TileObject fromCache2_1 = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet2", "image/png");
        TileObject fromCache1_2 = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet1", "image/png");
        TileObject fromCache2_2 = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet2", "image/png");
        TileObject fromCache2_3 = TileObject.createQueryTileObject("testLayer", new long[]{0L, 0L, 0L}, "testGridSet2", "image/png");
    ...
    public void testDeleteGridset() throws Exception {
        ...
        if(events) {
            listener.tileStored(eq("testLayer"), eq("testGridSet1"), eq("image/png"), eq(null), eq(0L), eq(0L), eq(0), 
                geq(size1), eq(0), eq(null), eq(null)
                );EasyMock.expectLastCall();
        }
    ...
    public void testParameters() throws Exception {
        ...
        if(events){
            listener.tileStored(eq("testLayer"), eq("testGridSet"), eq("image/png"), capture(pidCapture1), eq(0L), eq(0L), eq(0), 
                capture(sizeCapture1), eq(0), eq(null), eq(ParametersUtils.getLegacyParametersKvp(params1))
                );EasyMock.expectLastCall();
            listener.tileStored(eq("testLayer"), eq("testGridSet"), eq("image/png"), capture(pidCapture2), eq(0L), eq(0L), eq(0), 
                capture(sizeCapture2), eq(0), eq(null), eq(ParametersUtils.getLegacyParametersKvp(params2))
                );EasyMock.expectLastCall();
        }
    ...
    public void testDeleteByParametersId() throws Exception {
        ...
        if(events) {
            listener.tileStored(eq("testLayer"), eq("testGridSet"), eq("image/png"), eq(paramID1), eq(0L), eq(0L), eq(0), 
                geq(size1), eq(0), eq(null), eq(ParametersUtils.getLegacyParametersKvp(params1))
                );
            listener.tileStored(eq("testLayer"), eq("testGridSet"), eq("image/png"), eq(paramID2), eq(0L), eq(0L), eq(0), 
                geq(size2), eq(0), eq(null), eq(ParametersUtils.getLegacyParametersKvp(params2))
                );
        }
    ...
    public void testPurgeOrphansWithDefault() throws Exception {
        ...
        if(events) {
            listener.tileStored(eq(layerName), eq(gridset), eq(format), eq(paramID1), eq(0L), eq(0L), eq(0), 
                anyLong(), eq(0), eq(null), eq(ParametersUtils.getLegacyParametersKvp(params1))
                );
            listener.tileStored(eq(layerName), eq(gridset), eq(format), eq(paramID2), eq(0L), eq(0L), eq(0), 
                anyLong(), eq(0), eq(null), eq(ParametersUtils.getLegacyParametersKvp(params2))
                );
            listener.tileStored(eq(layerName), eq(gridset), eq(format), isNull(), eq(0L), eq(0L), eq(0), 
                anyLong(), eq(0), eq(null), eq(null)
                );
        }
